...
public class CookieUtils {
	private static int MAXAGE = 60*60*24*90;
	/*
	 * 设置 Cookie, 过期时间为60*60*24*90=90天
	 */
    ...
    public static Cookie setCookie(HttpServletResponse response, String name, String value, String path) {
        return addCookie(response, name, value, path, MAXAGE);
    }
     ...
     * @return 值
     */
    public static String getCookieAndDel(HttpServletRequest request, HttpServletResponse response, String name) {
